...
**In activity 4 we used read.csv instead of read_csv function**:
...
**Its gonna be mostly close to median but will have values on higher end as well**:
...
**Highest median earning is for major "Law & Public Policy and the least median income is for major "Psychology & Social Work"**:
